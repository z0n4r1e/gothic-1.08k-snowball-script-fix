...
instance RMELTER_SPARKS(C_PARTICLEFX)
{
	ppsvalue = 200;
	...
	vissizestart_s = "5 5 5 ";
	vissizeendscale = 0.1;
	visalphafunc_s = "ADD";
	visalphastart = 200;
};

instance MOBSI_RUNEMAKER_INVEST(C_PARTICLEFX)
{
	ppsvalue = 200;
	...
	vistexanifps = 3;
	vistexaniislooping = 1;
	vistexcolorstart_s = "255  128 200";
...
instance MOBSI_RUNEMAKER_CAST(C_PARTICLEFX)
{
	ppsvalue = 100;
	ppsscalekeys_s = "1 1 1 1";
	ppsfps = 1;
	ppsislooping = 0;
	ppscreateem_s = "MOBSI_RUNEMAKER_CAST_CHILD";
	shptype_s = "POINT";
	shpfor_s = "object";
...
instance MOBSI_RUNEMAKER_BLAST(C_PARTICLEFX)
{
	ppsvalue = 30;
	ppsscalekeys_s = "1";
	ppsfps = 1;
	...
	visorientation_s = "VELO";
	vistexisquadpoly = 1;
	vistexcolorstart_s = "230 100 220";
	vistexcolorend_s = "0 0 0";
...
instance CARVEWOOD(C_PARTICLEFX)
{
	ppsvalue = 200;
	ppsscalekeys_s = "1";
	ppsissmooth = 1;
...
instance PICKSTONE(C_PARTICLEFX)
{
	ppsvalue = 200;
	ppsscalekeys_s = "1";
	ppsissmooth = 1;
...
instance CRW_GLIBBER_SLOW(C_PARTICLEFX)
{
	ppsvalue = 60;
	ppsscalekeys_s = "1";
	ppsislooping = 1;
...
instance CRW_FOG(C_PARTICLEFX)
{
	...
	vistexanifps = 18;
	vistexaniislooping = 1;
	vistexcolorstart_s = "255 180 255";
	vistexcolorend_s = "250 150 0";
...
instance WASTEOUTLET(C_PARTICLEFX)
{
	...
	lsppartavg = 1300;
	lsppartvar = 200;
	flygravity_s = "0 -0.0008";
	visname_s = "WATERSPLASH1.TGA";
	visorientation_s = "VELO";
	vistexisquadpoly = 1;
	vistexanifps = 15;
	vistexaniislooping = 1;
	vistexcolorstart_s = "92 112 67";
	vistexcolorend_s = "87 136 136";
	vissizestart_s = "1 2";
	vissizeendscale = 10;
	visalphafunc_s = "ADD";
	visalphastart = 100;
...
instance WASTEOUTLET_BOTTOM(C_PARTICLEFX)
{
	...
	vistexanifps = 15;
	vistexaniislooping = 1;
	vistexcolorstart_s = "92 112 100";
	vistexcolorend_s = "87 136 160";
	vissizestart_s = "1 1";
	vissizeendscale = 5;
	visalphafunc_s = "ADD";
	visalphastart = 255;
