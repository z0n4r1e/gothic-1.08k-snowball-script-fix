...
func void ZS_ReactToDamage()
{
	...
	{
		self.aivar[AIV_LASTHITBYRANGEDWEAPON] = 1;
	}
	else
	{
		self.aivar[AIV_LASTHITBYRANGEDWEAPON] = 0;
	};
	if(!C_NpcIsMonster(other))
	{
		if(Npc_IsPlayer(other))
		{
			...
			{
				PrintDebugNpc(PD_ZS_Check,"...NSC ДРУЖЕЛЮБЕН к Нападающему");
			...
			{
				PrintDebugNpc(PD_ZS_Check,"...NSC не ДРУЖЕЛЮБЕН к Нападающему!");
