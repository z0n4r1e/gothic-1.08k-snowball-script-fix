...
func int ZS_HealSelf_Loop()
{
	...
	{
		PrintDebugNpc(PD_ZS_Check,"...Полностью вылечен!");
		return LOOP_END;
	}
	...
	{
		PrintDebugNpc(PD_ZS_Check,"...Отсутствуют дополнительные средства для Лечения!");
		return LOOP_END;
	};
...
func int ZS_HealSelfMana_Loop()
{
	...
	{
		PrintDebugNpc(PD_ZS_Check,"...Мана полностью восстановлена!");
		return LOOP_END;
	}
	...
	{
		PrintDebugNpc(PD_ZS_Check,"...Нет более средств для восстановления Маны!");
		return LOOP_END;
	};
	AI_Wait(self,0.5);
	return LOOP_CONTINUE;
