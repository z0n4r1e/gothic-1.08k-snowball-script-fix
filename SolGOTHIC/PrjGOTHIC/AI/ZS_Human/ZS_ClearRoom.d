...
func void ZS_ClearRoom_End()
{
	...
	{
		PrintDebugNpc(PD_ZS_Check,"...Nsc сильнее!");
	...
	{
		PrintDebugNpc(PD_ZS_Check,"...Nsc слабее!");
...
func void ZS_ClearRoomWait_Loop()
{
	...
	{
		PrintDebugNpc(PD_ZS_Check,"...NSC  ждет в течение 8 Секунд!");
...
func void B_ClearRoomEnterRoom()
{
	...
	{
		PrintDebugNpc(PD_ZS_Check,"...NSC видит SC!");
		if(Wld_GetPlayerPortalGuild() == GIL_None)
		{
			PrintDebugNpc(PD_ZS_Check,"...SC больше не в Комнате!");
			if(C_AmIStronger(self,other))
			{
				AI_TurnToNPC(self,other);
				B_Say(self,other,"$WISEMOVE");
		...
		{
			PrintDebugNpc(PD_ZS_Check,"...SC снова в Комнате!");
			if(C_AmIStronger(self,other))
			{
				PrintDebugNpc(PD_ZS_Check,"...сильнее");
				AI_TurnToNPC(self,other);
				B_Say(self,other,"$YOUASKEDFORIT");
				Npc_SetTarget(self,other);
				AI_StartState(self,ZS_Attack,0,"");
			...
			{
				PrintDebugNpc(PD_ZS_Check,"...не сильнее --> Вызвать Охрану");
				AI_StartState(self,ZS_CallGuardsOnEnterRoom,0,"");
			};
		};
	};
