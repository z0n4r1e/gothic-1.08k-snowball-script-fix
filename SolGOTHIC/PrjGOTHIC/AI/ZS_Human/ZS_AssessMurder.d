...
func void ZS_AssessMurder()
{
	...
	if(Npc_CanSeeNpcFreeLOS(self,other) || Npc_CanSeeNpcFreeLOS(self,victim))
	{
		...
		{
			PrintDebugNpc(PD_ZS_Check,"...Убийство Монстра!");
		...
		{
			PrintDebugNpc(PD_ZS_Check,"...Убийство Монстров!");
		...
		{
			PrintDebugNpc(PD_ZS_Check,"...NSC является Стражем, и Подопечный был убит!");
