...
func void ZS_Talk()
{
	...
	{
		PrintDebugNpc(PD_ZS_Check,"...SC уже разговаривает!");
	...
	AI_OutputSVM_Overlay(self,other,"INFO_EMPTY_00");
};
...
func int ZS_Talk_Loop()
{
	...
	{
		PrintDebugNpc(PD_ZS_Check,"...Инфо Мэнэджер завершен!");
		self.aivar[AIV_INVINCIBLE] = 0;
		other.aivar[AIV_INVINCIBLE] = 0;
