...
func void ZS_Orc_WalkAround_Loop()
{
	...
	{
		PrintDebugNpc(PD_ZS_FRAME,"ZS_Orc_WalkAround: Перейти к Ближайшему");
		AI_GotoWP(self,wp1);
		self.wp = wp1;
	}
	else if(!Hlp_StrCmp(wp2,self.wp))
	{
		PrintDebugNpc(PD_ZS_FRAME,"ZS_Orc_WalkAround: Перейти к Следующему");
		AI_GotoWP(self,wp2);
		self.wp = wp2;
	};
	if(Hlp_Random(80) < 10)
	{
		PrintDebugNpc(PD_ZS_FRAME,"ZS_Orc_WalkAround: Пустая Анимация");
		B_Orc_Idle_Ani();
		AI_Wait(self,2);
		return;
	};
	if(Hlp_Random(50) < 5)
	{
		PrintDebugNpc(PD_ZS_FRAME,"ZS_Orc_WalkAround: Подождать");
...
func void ZS_Orc_GuardSleepy_Loop()
{
	...
	{
		PrintDebugNpc(PD_ZS_FRAME,"ZS_Orc_GuardSleepy_Loop: Анимация стояния");
		B_Orc_Idle_Ani();
		return;
	};
	if(!C_BodyStateContains(self,BS_SIT) && (Hlp_Random(600) < 10))
	{
		PrintDebugNpc(PD_ZS_FRAME,"ZS_Orc_GuardSleepy_Loop: Сесть");
	...
	{
		PrintDebugNpc(PD_ZS_FRAME,"ZS_Orc_GuardSleepy_Loop: заснуть Сидя");
...
func void ZS_Orc_SitOnFloor()
{
	...
	if(Npc_GetBodyState(self) != BS_SIT)
	{
		PrintDebugNpc(PD_ZS_FRAME,"ZS_Orc_SitOnFloor: не сидит....");
		AI_SetWalkMode(self,NPC_WALK);
