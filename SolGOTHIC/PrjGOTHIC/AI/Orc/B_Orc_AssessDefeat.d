...
func void B_Orc_AssessDefeat()
{
	...
	if((Npc_GetPermAttitude(self,victim) == ATT_HOSTILE) || (Npc_GetPermAttitude(self,victim) == ATT_ANGRY))
	{
		...
		{
			PrintDebugNpc(PD_ORC_CHECK,"B_Orc_AssessDefeat: Враждебность прекратилась");
	...
	{
		PrintDebugNpc(PD_ORC_FRAME,"B_Orc_AssessDefeat: Носители оружия Дальнего боя - Свиньи");
