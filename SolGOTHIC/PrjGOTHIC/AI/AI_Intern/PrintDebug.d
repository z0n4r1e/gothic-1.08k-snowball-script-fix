...
func void PrintGuild(var int channel,var int guild)
{
	...
	if(guild == GIL_None)
	{
		PrintDebugNpc(channel,"...Гильдия: GIL_NONE");
	};
	if(guild == GIL_EBR)
	{
		PrintDebugNpc(channel,"...Гильдия: GIL_EBR");
	};
	if(guild == GIL_GRD)
	{
		PrintDebugNpc(channel,"...Гильдия: GIL_GRD");
	};
	if(guild == GIL_STT)
	{
		PrintDebugNpc(channel,"...Гильдия: GIL_STT");
	};
	if(guild == GIL_KDF)
	{
		PrintDebugNpc(channel,"...Гильдия: GIL_KDF");
	};
	if(guild == GIL_VLK)
	{
		PrintDebugNpc(channel,"...Гильдия: GIL_VLK");
	};
	if(guild == GIL_KDW)
	{
		PrintDebugNpc(channel,"...Гильдия: GIL_KDW");
	};
	if(guild == GIL_SLD)
	{
		PrintDebugNpc(channel,"...Гильдия: GIL_SLD");
	};
	if(guild == GIL_ORG)
	{
		PrintDebugNpc(channel,"...Гильдия: GIL_ORG");
	};
	if(guild == GIL_BAU)
	{
		PrintDebugNpc(channel,"...Гильдия: GIL_BAU");
	};
	if(guild == GIL_SFB)
	{
		PrintDebugNpc(channel,"...Гильдия: GIL_SFB");
	};
	if(guild == GIL_GUR)
	{
		PrintDebugNpc(channel,"...Гильдия: GIL_GUR");
	};
	if(guild == GIL_NOV)
	{
		PrintDebugNpc(channel,"...Гильдия: GIL_NOV");
	};
	if(guild == GIL_TPL)
	{
		PrintDebugNpc(channel,"...Гильдия: GIL_TPL");
	};
	if(guild == GIL_DMB)
	{
		PrintDebugNpc(channel,"...Гильдия: GIL_DMB");
	};
	if(guild == GIL_BAB)
	{
		PrintDebugNpc(channel,"...Гильдия: GIL_BAB");
	};
};
