...
func int B_CheckItem(var int category,var int slot)
{
	...
	{
		printText = ConcatStrings("...обнаружено INV_WEAPON_",printText);
	}
	else if(category == INV_ARMOR)
	{
		printText = ConcatStrings("...обнаружено INV_ARMOR_",printText);
	}
	else if(category == INV_RUNE)
	{
		printText = ConcatStrings("...обнаружено INV_RUNE_",printText);
	}
	else if(category == INV_FOOD)
	{
		printText = ConcatStrings("...обнаружено INV_FOOD_",printText);
	}
	else if(category == INV_DOC)
	{
		printText = ConcatStrings("...обнаружено INV_DOC_",printText);
	}
	else if(category == INV_MISC)
	{
		printText = ConcatStrings("...обнаружено INV_MISC_",printText);
	}
	else
	{
		printText = ConcatStrings("...обнаружена неизвестная категория #",printText);
	};
...
func int B_Plunder()
{
	...
	PrintDebugInt(PD_ZS_Check,"...Количество украденных предметов: ",amountPlundered);
