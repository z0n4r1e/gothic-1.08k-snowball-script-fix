...
func void B_AssessBody()
{
	...
	{
		PrintDebugNpc(PD_ZS_Check,"...Тело на расстоянии менее 10m!");
		B_FullStop(self);
...
func void ZS_AssessBody()
{
	...
	{
		PrintDebugNpc(PD_ZS_Check,"...Тело уже ограблено!");
		AI_ContinueRoutine(self);
	};
	if(Npc_GetDistToNpc(self,other) > PERC_DIST_INTERMEDIAT)
	{
		PrintDebugNpc(PD_ZS_Check,"...Тело слишком далеко!");
		AI_ContinueRoutine(self);
	};
};
...
func void ZS_AssessBody_End()
{
	...
	{
		PrintDebugNpc(PD_ZS_Check,"...Не Стрелок и не Друг NSC!");
...
func void ZS_AssessBody_RecoverWeapon()
{
	...
	{
		PrintDebugNpc(PD_ZS_Check,"...найдено Оружие для ближнего или дальнего боя!");
