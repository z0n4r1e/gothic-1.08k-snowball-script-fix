...
func void B_GuildGreetings()
{
	...
	{
		PrintDebugNpc(PD_ZS_Check,"B_GuilGreetings Гуру ");
	...
	{
		PrintDebugNpc(PD_ZS_Check,"B_GuilGreetings OC оба");
	...
	{
		PrintDebugNpc(PD_ZS_Check,"B_GuilGreetings NC оба");
		B_Say(self,other,"$MAGEGREETINGS");
	}
	else if(Npc_GetTempAttitude(self,other) == ATT_FRIENDLY)
	{
		PrintDebugNpc(PD_ZS_Check,"B_GuilGreetings друг");
