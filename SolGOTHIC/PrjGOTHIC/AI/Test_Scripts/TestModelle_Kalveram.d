...
{
	name = "Перевести Идола Люкора в Режим Следования";
...
func void UseLukor_Bugfixbook()
{
	...
	Doc_PrintLine(nDocID,0,"Заставить Идола Люкора");
	Doc_PrintLine(nDocID,0,"следовать за вами");
...
func void UseLester_Bugfixbook()
{
	...
	Doc_SetFont(nDocID,-1,"font_10_book.tga");
	Doc_SetMargins(nDocID,0,275,20,30,20,1);
	Doc_PrintLine(nDocID,0,"Послать Лестера");
	Doc_PrintLine(nDocID,0,"Домой");
	Doc_PrintLines(nDocID,0,"");
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLines(nDocID,0,"");
	Doc_PrintLine(nDocID,0,"");
