...
{
	PrintDebugNpc(PD_MAGIC,"B_AssessMagic_ChainLightning");
...
{
	PrintDebugNpc(PD_MAGIC,"B_AssessMagic_ThunderBall");
	Npc_SendPassivePerc(self,PERC_ASSESSFIGHTSOUND,self,other);
	Npc_ClearAIQueue(self);
	if(!Npc_IsDead(self))
	{
...
{
	PrintDebugNpc(PD_MAGIC,"B_AssessMagic_IceCube");
	Npc_SendPassivePerc(self,PERC_ASSESSFIGHTSOUND,self,other);
...
func void B_AssessMagic_Fear()
{
	...
	{
		PrintDebugNpc(PD_MAGIC,"...иммунитет Цели!");
	}
	else
	{
		PrintDebugNpc(PD_MAGIC,"...у Цели нет иммунитета!");
		Npc_ClearAIQueue(self);
...
func void B_AssessMagic_Charm()
{
	...
	{
		PrintDebugNpc(PD_ZS_Check,"...NSC это сознательный человек!");
...
{
	PrintDebugNpc(PD_MAGIC,"B_AssessMagic_Pyrokinesis");
	Npc_ClearAIQueue(self);
	Npc_PercDisable(self,PERC_ASSESSCASTER);
	Npc_SendPassivePerc(self,PERC_ASSESSFIGHTSOUND,self,other);
	if(!Npc_IsDead(self) && !Npc_IsInState(self,ZS_Unconscious))
	{
		PrintDebugNpc(PD_MAGIC,"...ни без сознания, ни мертвый!");
...
{
	PrintDebugNpc(PD_MAGIC,"B_AssessMagic_Berzerk");
	Npc_SendPassivePerc(self,PERC_ASSESSFIGHTSOUND,self,other);
	Npc_ClearAIQueue(self);
	if(!Npc_IsDead(self) && !Npc_IsInState(self,ZS_Unconscious))
	{
...
{
	PrintDebugNpc(PD_MAGIC,"B_AssessMagic_Shrink");
	Npc_SendPassivePerc(self,PERC_ASSESSFIGHTSOUND,self,other);
	Npc_ClearAIQueue(self);
...
{
	PrintDebugNpc(PD_MAGIC,"B_AssessMagic_Control");
	Npc_SendPassivePerc(self,PERC_ASSESSFIGHTSOUND,self,other);
};
