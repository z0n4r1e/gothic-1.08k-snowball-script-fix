...
func int ZS_Berzerk_Loop()
{
	...
	{
		PrintDebugNpc(PD_ZS_Check,"...больше не является допустимой Целью!");
		Npc_PerceiveAll(self);
		if(Wld_DetectNpcEx(self,-1,NOFUNC,-1,FALSE))
		{
			PrintDebugNpc(PD_ZS_Check,"...Обнаружена новая Цель!");
			PrintGlobals(PD_ZS_DETAIL);
		...
		{
			PrintDebugNpc(PD_ZS_Check,"...больше нет новой Цели!");
			PrintGlobals(PD_ZS_DETAIL);
