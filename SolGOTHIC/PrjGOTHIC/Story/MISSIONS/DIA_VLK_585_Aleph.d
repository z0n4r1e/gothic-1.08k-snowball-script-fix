...
instance VLK_585_Aleph_INFO(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "Ладно, вот тебе 10 кусков.";
};
...
{
	AI_Output(other,self,"VLK_585_Aleph_KEY_Info_15_01");	//Узнал что-нибудь новенькое?
...
instance VLK_585_Aleph_GLEN(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "...я хочу получить действительно полезную информацию!";
};
...
instance VLK_585_Aleph_SCHUPPEN(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "...где можно найти ключ от сундуков на складе?";
};
...
func void VLK_585_Aleph_SCHUPPEN_Info()
{
	...
	Info_AddChoice(VLK_585_Aleph_SCHUPPEN,"Я думаю, 50 кусков руды будет более чем достаточно.",VLK_585_Aleph_SCHUPPEN_50);
	Info_AddChoice(VLK_585_Aleph_SCHUPPEN,"Что скажешь по поводу 30 кусков руды?",VLK_585_Aleph_SCHUPPEN_30);
	Info_AddChoice(VLK_585_Aleph_SCHUPPEN,"15 кусков руды - вот все, что я могу предложить.",VLK_585_Aleph_SCHUPPEN_15);
};
...
func void VLK_585_Aleph_DIRTY_Info()
{
	...
	Info_AddChoice(VLK_585_Aleph_DIRTY,"Ладно, вымогатель. Вот твои 100 кусков.",VLK_585_Aleph_DIRTY_100);
	Info_AddChoice(VLK_585_Aleph_DIRTY,"Я не собираюсь выкидывать 100 кусков на ветер!",VLK_585_Aleph_DIRTY_NO);
};
