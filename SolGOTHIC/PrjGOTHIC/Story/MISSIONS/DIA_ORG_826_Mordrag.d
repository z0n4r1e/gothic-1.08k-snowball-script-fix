...
func void Org_826_Mordrag_Courier_Info()
{
	...
	AI_Output(self,other,"Org_826_Mordrag_Courier_11_03");	//Курьеры носят печать, которая служит пропуском в замок. Если ты станешь одним из нас, ты получишь ее.
};
...
func void Org_826_Mordrag_AtNewcamp_Info()
{
	...
	Lares.aivar[AIV_FINDABLE] = 1;
	MordragKO_StayAtNC = 1;
...
func void Org_826_Mordrag_Fight_Info()
{
	...
	Info_AddChoice(Org_826_Mordrag_Fight,"Меня послал Торус.",Info_Mordrag_Fight_Thorus);
};
...
func void Info_Mordrag_Fight_OreBarons()
{
	...
	MordragKO_PlayerChoseOreBarons = 1;
	AI_StopProcessInfos(self);
	Npc_SetTarget(self,other);
	AI_StartState(self,ZS_Attack,1,"");
};
...
func void Org_826_Mordrag_RUNNING_Info()
{
	...
	if(CorKalom_BringMCQBalls == LOG_SUCCESS)
	{
		if(Kapitel >= 3)
		{
			AI_Output(other,self,"Org_826_Mordrag_RUNNING_15_04");	//Великая Церемония Состоялась.
