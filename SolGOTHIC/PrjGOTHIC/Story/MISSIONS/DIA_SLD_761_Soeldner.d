...
func void DIA_SLD_761_Soeldner_Bribe_INFO()
{
	...
	AI_Output(self,other,"DIA_SLD_761_Soeldner_Bribe_INFO_03_02");	//А что мы должны делать?
	AI_Output(self,other,"DIA_SLD_761_Soeldner_Bribe_INFO_03_03");	//Минутку! Если ты попытаешься подкупить меня, то знай: ты не на того напал, приятель!
