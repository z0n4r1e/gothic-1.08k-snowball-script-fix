...
instance DIA_Milten_Letter(C_Info)
{
	...
	permanent = 0;
	description = "У меня письмо для Верховного Мага Круга Огня.";
};
...
func void Info_Milten_SHOFFER_Info()
{
	...
	AI_Output(self,hero,"Info_Milten_SHOFFER_02_08");	//Х-м-м... ну... план-то есть, но одному мне не справиться.
};
...
func void Info_Milten_SHOFFER2_Info()
{
	...
	AI_Output(self,hero,"Info_Milten_SHOFFER2_02_05");	//Х-х-м... Ну... Не совсем. С некоторых пор там обитает не только страж.
...
instance Info_Milten_SHSCROLL(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "Я потратил заклинание - но не на стража!";
};
...
instance Info_Milten_SHCONTINUE(C_Info)
{
	...
	important = 0;
	permanent = 1;
	description = "...может быть, нам стоит еще разок наведаться к стражу?";
};
...
instance Info_Milten_OCWHY(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "Зачем Баронам понадобилось убивать магов?";
};
...
instance Info_Milten_OCYOU(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "Тебе нужно спрятаться.";
};
...
instance Info_Milten_LOADSWORD4(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "Ксардас дал мне заклинание для переноса силы!";
};
...
func void Info_Milten_LOADSWORD4_Info()
{
	...
	B_UseFakeScroll();
	AI_Output(self,hero,"Info_Milten_LOADSWORD4_02_03");	//Эээ... Ну, если мне нужно только прочесть заклинание...
