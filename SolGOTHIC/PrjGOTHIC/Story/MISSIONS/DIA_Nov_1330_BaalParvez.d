...
func void DIA_BaalParvez_MyAdvantage_Info()
{
	...
	AI_Output(self,other,"DIA_BaalParvez_MyAdvantage_10_05");	//Стоит подумать об этом, прежде чем ты решишься присоединиться к какому-нибудь другому Лагерю.
};
...
instance DIA_BaalParvez_GotoPSI(C_Info)
{
	...
	permanent = 1;
	description = "Отведи меня в свой Лагерь.";
};
