...
func void DIA_Fingers_Lehrer_Schleichen()
{
	...
	AI_Output(self,other,"DIA_Fingers_Lehrer_Schleichen_05_02");	//Но когда речь идет об обучении искусству подкрадываться, тебе лучше обратиться к Кавалорну.
	Fingers_Wherecavalorn = 1;
};
