...
instance DIA_Lester_HowProofWorthy(C_Info)
{
	...
	permanent = 0;
	description = "...никто из Гуру не желает со мной разговаривать?";
};
...
func void PC_Psionic_GUIDEFIRST_Info()
{
	...
	Info_AddChoice(PC_Psionic_GUIDEFIRST,"... наставники?",PC_Psionic_GUIDEFIRST_TRAIN);
...
func void Info_Lester_DIEGOMILTEN_Info()
{
	...
	AI_Output(hero,self,"Info_Grd_6_DasLager_WasIstAerger_15_04");	//Ладно, ладно, я понял.
