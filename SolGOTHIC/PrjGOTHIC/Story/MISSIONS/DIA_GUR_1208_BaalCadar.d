...
func void DIA_BaalCadar_NoTalk_Hi()
{
	...
	AI_Output(self,other,"DIA_BaalCadar_NoTalk_Hi_02_01");	//Оооох...
	BaalCadar_Sakrileg = 1;
};

func void DIA_BaalCadar_NoTalk_Sleeper()
{
	AI_Output(other,self,"DIA_BaalCadar_NoTalk_Sleeper_15_00");	//Да пребудет с тобой Спящий!
	AI_Output(self,other,"DIA_BaalCadar_NoTalk_Sleeper_02_01");	//Оооох...
	BaalCadar_Sakrileg = 1;
};
...
func void DIA_BaalCadar_NoTalk_Imp()
{
	...
	AI_Output(self,other,"DIA_BaalCadar_NoTalk_Imp_02_01");	//Оооох...
	BaalCadar_Sakrileg = 1;
};
...
{
	AI_Output(other,self,"Gur_1208_BaalCadar_Teach_Info_15_01");	//Мне бы хотелось узнать, как увеличить силу своей магии.
...
instance Gur_1208_BaalCadar_SELLSTUFF(C_Info)
{
	...
	important = 0;
	permanent = 1;
	description = "Я хочу овладеть магическими знаками.";
	trade = 1;
};
