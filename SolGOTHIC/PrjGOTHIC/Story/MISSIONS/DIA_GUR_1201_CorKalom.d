...
instance GUR_1201_CorKalom_JoinPSI2(C_Info)
{
	...
	permanent = 0;
	description = "...Ни тебе 'добро пожаловать', ни добрых пожеланий...";
};
...
func void Info_Kalom_DrugMonopol_Info()
{
	...
	Renyu.aivar[AIV_WASDEFEATEDBYSC] = 0;
	Killian = Hlp_GetNpc(Org_861_Killian);
	Killian.aivar[AIV_WASDEFEATEDBYSC] = 0;
};
...
func void GUR_1201_CorKalom_CRAWLER_Info()
{
	...
	AI_Output(self,other,"GUR_1201_CorKalom_CRAWLER_Info_10_02");	//В шахте ты встретишь Стражей. Они охотятся на позунов и добывают для меня их жвалы. Поговори с Гор На Видом - он поможет тебе.
};
...
func void Info_CorKalom_Belohnung_Info()
{
	...
	Info_AddChoice(Info_CorKalom_Belohnung,"Отдай мне эти свитки с заклинаниями.",Info_CorKalom_Belohnung_SCROLL);
	Info_AddChoice(Info_CorKalom_Belohnung,"Мне бы пригодилась руда.",Info_CorKalom_Belohnung_ORE);
	Info_AddChoice(Info_CorKalom_Belohnung,"Мне нужны магические эликсиры.",Info_CorKalom_Belohnung_MANA);
};
