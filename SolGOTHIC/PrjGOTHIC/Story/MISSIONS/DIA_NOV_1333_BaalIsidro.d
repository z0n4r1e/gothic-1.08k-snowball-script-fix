...
instance DIA_BaalIsidro_Drink(C_Info)
{
	...
	permanent = 1;
	description = "...Выпей еще - за мой счет.";
};
...
instance DIA_BaalIsidro_ThinkAgain(C_Info)
{
	...
	permanent = 1;
	description = "...ты отдашь мне болотник, и мы поделим прибыль. ";
};
...
func void DIA_BaalIsidro_ThinkAgain_Info()
{
	...
	if((BaalIsidro_GotDrink == TRUE) && Npc_KnowsInfo(hero,DIA_BaalIsidro_Problem))
	{
		...
		AI_Output(self,other,"DIA_BaalIsidro_ThinkAgain_03_06");	//Теперь, когда я сбыл эту траву с рук, я чувствую себя намного лучше.
...
instance DIA_BaalIsidro_RUNNING(C_Info)
{
	...
	permanent = 0;
	description = "Я продал твой болотник.";
};
...
func void DIA_BaalIsidro_RUNNING_Info()
{
	...
	if(Npc_HasItems(other,ItMiNugget) >= 200)
	{
		...
		AI_Output(self,other,"DIA_BaalIsidro_RUNNING_03_03");	//Хорошо... И к черту Идола Кагана! Ха-ха-ха!
