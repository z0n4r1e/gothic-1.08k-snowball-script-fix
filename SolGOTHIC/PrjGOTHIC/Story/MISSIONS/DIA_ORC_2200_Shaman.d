...
instance Info_OrcShaman_MINE(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "Ты был рабом в шахте?";
};
...
func void Info_OrcShaman_OUTSIDE_Info()
{
	...
	AI_Output(self,hero,"Info_OrcShaman_OUTSIDE_17_02");	//Они запечатали храм. Братья поклоняются КРУШАКУ.
...
instance Info_OrcShaman_OTHERWAY(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "...Но мне действительно нужно попасть в храм!";
};
...
func void Info_OrcShaman_OTHERWAY_Info()
{
	...
	AI_Output(self,hero,"Info_OrcShaman_OTHERWAY_17_02");	//Ур Шак знает путь! Незнакомец наденет УЛУ МУЛУ. 
	...
	AI_Output(self,hero,"Info_OrcShaman_OTHERWAY_17_05");	//Незнакомец наденет УЛУ МУЛУ и не умрет!
};
...
func void Info_OrcShaman_ULUMULU_Info()
{
	...
	AI_Output(self,hero,"Info_OrcShaman_ULUMULU_17_03");	//Друг Ур Шака даст незнакомцу УЛУ МУЛУ. Незнакомец наденет УЛУ МУЛУ и не умрет!
...
func void Info_OrcShaman_IDOL_Info()
{
	...
	{
		AI_Output(self,hero,"Info_OrcShaman_IDOL_17_00");	//Есть какой-нибудь другой путь в храм?
	...
	{
		AI_Output(hero,self,"Info_OrcShaman_IDOL_17_00");	//Есть какой-нибудь другой путь в храм?
