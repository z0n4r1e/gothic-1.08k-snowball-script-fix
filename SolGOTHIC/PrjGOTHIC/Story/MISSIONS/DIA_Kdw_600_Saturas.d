...
func void Info_Saturas_FAVOR_Info()
{
	...
	AI_Output(self,other,"Info_Saturas_FAVOR_14_06");	//Напомни магам Огня про старое доброе время, когда мы вместе постигали искусство магии.
};
...
instance Info_Saturas_MURDER(C_Info)
{
	...
	permanent = 0;
	important = 0;
	description = "Гомез избавился от всех магов Огня!";
};
...
instance KDW_600_Saturas_OATH(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "...теперь я принадлежу к гильдии магов Воды?";
};
...
instance Info_Saturas_XARDAS(C_Info)
{
	...
	permanent = 0;
	important = 0;
	description = "Отправляя меня к магам Огня, ты упомянул... КОЕ-КОГО.";
};
...
func void Info_Saturas_XARDASWHY_Info()
{
	...
	AI_Output(self,hero,"Info_Saturas_XARDASWHY_14_03");	//Гомез был не единственным из тех, кто начал беспокоиться. Большинство магов выступило против Ксардаса и его нечестивых экспериментов.
...
func void KDW_600_Saturas_TIMESUP_JA3()
{
	...
	AI_Output(other,self,"KDW_600_Saturas_TIMESUP_Info_15_11");	//Железная гора... ах...  Она уже очень высокая!
