...
func void DIA_BaalNamib_NoTalk_Hi()
{
	...
	AI_Output(self,other,"DIA_BaalNamib_NoTalk_Hi_02_01");	//Оооох...
	BaalNamib_Sakrileg = 1;
};

func void DIA_BaalNamib_NoTalk_Sleeper()
{
	AI_Output(other,self,"DIA_BaalNamib_NoTalk_Sleeper_15_00");	//Да пребудет с тобой Спящий!
	AI_Output(self,other,"DIA_BaalNamib_NoTalk_Sleeper_02_01");	//Оооох...
	BaalNamib_Sakrileg = 1;
};
...
func void DIA_BaalNamib_NoTalk_Imp()
{
	...
	AI_Output(self,other,"DIA_BaalNamib_NoTalk_Imp_02_01");	//Оооох...
	BaalNamib_Sakrileg = 1;
};
...
{
	AI_Output(self,other,"DIA_BaalNamib_FirstTalk_02_00");	//Оооох...
...
{
	AI_Output(other,self,"DIA_BaalNamib_FirstTalk_Mute_15_00");	//Оооох...
...
func void GUR_1204_BaalNamib_ARMOR_Info()
{
	...
	if(Kapitel < 3)
	{
		AI_Output(self,other,"GUR_1204_BaalNamib_ARMOR_Info_02_02");	//Тебе еще рано носить тяжелый доспех послушника.
	}
...
func void Info_BaalNamib_BROTHERHOOD_Info()
{
	...
	Info_AddChoice(Info_BaalNamib_BROTHERHOOD,"Я обращусь к нему немедленно.",Info_BaalNamib_BROTHERHOOD_OK);
