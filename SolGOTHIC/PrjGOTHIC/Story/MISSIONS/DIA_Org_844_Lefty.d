...
func void DIA_Lefty_FirstAtNight_Info()
{
	...
	AI_Output(other,self,"DIA_Ricelord_Arbeit_15_00");	//А для меня не найдется работы?
...
{
	AI_Output(self,other,"DIA_Lefty_First_07_00");	//Эй! Новенький? Мы ищем человека, чтобы отнес воду крестьянам на рисовые поля. 
	...
	Info_AddChoice(DIA_Lefty_First,"Может быть позже...",DIA_Lefty_First_Later);
