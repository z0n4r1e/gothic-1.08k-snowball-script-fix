...
instance GRD_261_Brandick_ALEPH(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "...Алеф весь день просто сидит и ничего не делает.";
};
...
func void GRD_261_Brandick_ALEPH_Info()
{
	...
	AI_Output(self,other,"GRD_261_Brandick_ALEPH_Info_06_03");	//Знаешь, кого я презираю больше, чем лентяев? Предателей. Так что проваливай!
	AI_StopProcessInfos(self);
};
