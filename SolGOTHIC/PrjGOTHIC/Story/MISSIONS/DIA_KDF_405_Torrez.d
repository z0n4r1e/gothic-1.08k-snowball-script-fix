...
instance DIA_Torrez_Belohnung(C_Info)
{
	...
	permanent = 0;
	description = "Меня прислал Корристо.";
};
...
func void DIA_Torrez_Belohnung_Info()
{
	...
	Info_AddChoice(DIA_Torrez_Belohnung,"Мне бы пригодился эликсир.",DIA_Torrez_Belohnung_ManaMax);
	Info_AddChoice(DIA_Torrez_Belohnung,"Дай мне эти магические свитки.",DIA_Torrez_Belohnung_Scrolls);
	Info_AddChoice(DIA_Torrez_Belohnung,"Я возьму Кольцо Ловкости.",DIA_Torrez_Belohnung_Dex);
	Info_AddChoice(DIA_Torrez_Belohnung,"Я возьму Кольцо Силы.",DIA_Torrez_Belohnung_Str);
};
...
instance DIA_Torrez_BriefTausch(C_Info)
{
	...
	permanent = 0;
	description = "Я принес тебе письмо...";
};
...
instance KDF_405_Torrez_SELLBOOKS(C_Info)
{
	...
	important = 0;
	permanent = 1;
	description = "Я хочу овладеть магическими письменами.";
	trade = 1;
};
...
instance KDF_405_Torrez_MANA(C_Info)
{
	...
	important = 0;
	permanent = 1;
	description = "Я хотел бы увеличить свою магическую силу.";
};
...
func void KDF_405_Torrez_MANA_Info()
{
	...
	Info_AddChoice(KDF_405_Torrez_MANA,"Мана +5 (5 Очков Обучения)",KDF_405_Torrez_MANA_MAN_5);
	Info_AddChoice(KDF_405_Torrez_MANA,"Мана +1 (1 Очко Обучения)",KDF_405_Torrez_MANA_MAN_1);
};
