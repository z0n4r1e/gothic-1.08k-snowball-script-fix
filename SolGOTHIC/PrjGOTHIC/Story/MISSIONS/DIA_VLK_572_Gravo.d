...
instance DIA_Gravo_HelpHow(C_Info)
{
	...
	permanent = 0;
	description = "То есть, если возникнут проблемы, ты сможешь помочь?";
};
...
instance DIA_Gravo_HelpAngryNow(C_Info)
{
	...
	permanent = 1;
	description = "Кажется, у меня возникла проблема.";
};
...
instance DIA_Gravo_Influence(C_Info)
{
	...
	permanent = 1;
	description = "...кто из Призраков здесь самый главный?";
};
