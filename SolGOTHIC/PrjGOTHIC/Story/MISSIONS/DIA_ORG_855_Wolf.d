...
instance Org_855_Wolf_TRADE(C_Info)
{
	...
	permanent = 1;
	description = "Ты берешь в оплату что-нибудь, помимо руды?";
	trade = 1;
};
...
func void DIA_Wolf_SellArmor_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Wolf_SellArmor_WRONGGUILD_09_00");	//Прости, парень, я не могу ничего тебе продать. Ларс убьет меня, если узнает, что я продал доспех чужаку. 
	};
};
...
func void DIA_Wolf_SellArmor_M()
{
	...
	{
		AI_Output(self,other,"DIA_Wolf_SellArmor_M_09_03");	//Это надежный доспех. Конечно, он не так хорош, как тот, что сейчас на мне, но он надежно защитит тебя.
...
func void DIA_Wolf_SellArmor_H()
{
	...
	{
		AI_Output(self,other,"DIA_Wolf_SellArmor_H_09_03");	//Этот доспех защитит тебя от любой опасности! Я сам ношу точно такой же и, как видишь, до сих пор еще жив - во многом благодаря этой броне. 
...
func void Info_Wolf_SPEAK_Info()
{
	...
	AI_Output(self,hero,"Info_Wolf_SPEAK_09_02");	//Да, у меня появилась идея, как сделать абсолютно новый доспех.
	AI_Output(hero,self,"Info_Wolf_SPEAK_15_03");	//Ооо... И ка же?
	...
	AI_Output(self,hero,"Info_Wolf_SPEAK_09_08");	//Если бы ты принес мне несколько таких пластинок, я бы сделал из них доспех.
};
...
func void Info_Wolf_SKIN_Info()
{
	...
	Knows_GetMCPlates = 1;
	PrintScreen("Изучено: Вырезание Панцирных Пластин",-1,-1,"FONT_OLD_20_WHITE.TGA",3);
...
instance Info_Wolf_PROFIT(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "...ты собираешься сделать для меня новые доспехи задаром!";
};
...
func void Info_Wolf_PROFIT_Info()
{
	...
	AI_Output(self,hero,"Info_Wolf_PROFIT_09_02");	//Не совсем... Если мне удастся сделать из этих пластин хороший доспех, я... очень скоро... очень много... ладно, забудь об этом!
};
...
func void Info_Wolf_MCPLATESFEW_Info()
{
	...
	AI_Output(self,hero,"Info_Wolf_MCPLATESFEW_09_02");	//Этого недостаточно! Их не хватит на доспех.
...
func void Info_Wolf_ARMORFINISHED_Info()
{
	...
	AI_Output(self,hero,"Info_Wolf_ARMORFINISHED_09_04");	//Да, приятель. Вот он. Лучший доспех во всем Лагере.
