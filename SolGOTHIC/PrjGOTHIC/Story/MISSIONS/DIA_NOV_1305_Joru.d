...
instance DIA_Joru_JoinPsi(C_Info)
{
	...
	permanent = 0;
	description = "Я хотел бы присоединиться к вашему Лагерю.";
};
...
{
	AI_Output(other,self,"DIA_Joru_JoinPsi_Ja_15_00");	//Да.
...
{
	AI_Output(other,self,"DIA_Joru_JoinPsi_Nein_15_00");	//Нет.
