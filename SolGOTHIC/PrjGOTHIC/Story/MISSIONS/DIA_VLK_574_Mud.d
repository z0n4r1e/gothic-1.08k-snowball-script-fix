...
{
	AI_Output(self,other,"DIA_Mud_Nerve_19_07_00");	//Мы с тобой одна команда. Мы можем править всем Старым Лагерем. Бароны нам теперь не помеха. Сейчас, я продумаю план.
	Npc_SetRefuseTalk(self,NerveSec);
	Mud_Nerve = 0;
	AI_StopProcessInfos(self);
};
