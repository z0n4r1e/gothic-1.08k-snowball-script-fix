...
func void Info_Bloodwyn_Hello_ForgetIt()
{
	...
	Bloodwyn_ProtectionPaid = 0;
	Herek_ProtectionBully = 1;
	Grim_ProtectionBully = 1;
...
func void Info_Bloodwyn_Hello_HowMuch()
{
	...
	{
		Info_AddChoice(Info_Bloodwyn_Hello,"Вот твоя руда.",Info_Bloodwyn_Hello_OkTakeIt);
	};
};
...
func void Info_Bloodwyn_Hello_OkTakeIt()
{
	...
	Bloodwyn_ProtectionPaid = 1;
	Herek_ProtectionBully = 0;
	Grim_ProtectionBully = 0;
...
func void Info_Bloodwyn_Hello_NotNow()
{
	...
	if(Npc_HasItems(other,ItMiNugget) > 0)
	{
		...
		{
			AI_Output(self,other,"Info_Bloodwyn_Hello_NotNow_TenOreMore_08_00");	//Ты только погляди на это... Похоже, кто-то не умеет считать до десяти, а?
...
func void Info_Bloodwyn_PayDay_Info()
{
	if(Bloodwyn_ProtectionPaid == TRUE)
	{
		...
		Info_AddChoice(Info_Bloodwyn_PayDay,"Вот, возьми.",Info_Bloodwyn_PayDay_PayAgain);
...
instance Info_Bloodwyn_Doch(C_Info)
{
	...
	permanent = 1;
	description = "...Вот десять кусков руды. ";
};
