...
func void DIA_Wedge_Lehrer_Lockpick2()
{
	...
	if(B_GiveSkill(other,NPC_TALENT_PICKLOCK,2,LPCOST_TALENT_PICKLOCK_2))
	{
		...
		AI_Output(self,other,"DIA_Wedge_Lehrer_Lockpick2_05_02");	//Думаю, у тебя получится. Приучай себя вслушиваться в тихое пощелкивание замка, и в будущем ты соберешь себе кучу отмычек.
