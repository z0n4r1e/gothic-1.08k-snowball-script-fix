...
func void DIA_Tpl_1415_Torwache_First_Info()
{
	...
	{
		Info_AddChoice(DIA_Tpl_1415_Torwache_First,"Я слышал о том, что вам нужны люди.",DIA_Tpl_1415_Torwache_First_Join);
	};
};
...
func void Tpl_1415_Templer_ROCK_Info()
{
	...
	AI_Output(self,other,"Tpl_1415_Templer_ROCK_Info_13_02");	//Ты должен заслужить право носить доспех Стража. Пока же я могу дать тебе набедренную повязку послушника.
