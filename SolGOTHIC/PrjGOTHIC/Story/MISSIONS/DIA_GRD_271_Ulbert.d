...
instance GRD_271_ULBERT_TRICK(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "Ты уже давно здесь стоишь.";
};
...
instance GRD_271_ULBERT_DRINK(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "Держи, прихватил специально для тебя!";
};
...
instance GRD_271_ULBERT_DRUNK(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "...что же все-таки хранится на складе?";
};
...
instance GRD_271_ULBERT_LOCK(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "Слушай, Ян с остальными сидит внизу и жарит мясо.";
};
