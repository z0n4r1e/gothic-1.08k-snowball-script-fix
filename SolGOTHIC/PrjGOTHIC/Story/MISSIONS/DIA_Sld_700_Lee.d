...
func void Sld_700_Lee_BECOMESLDNOW_Info()
{
	...
	AI_Output(self,other,"Sld_700_Lee_BECOMESLDNOW_Info_08_02");	//Правильный выбор. Ты об этом не пожалеешь.
...
instance Sld_700_Lee_CHANGESIDE(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "Меня выгнали из Старого Лагеря...";
};
...
func void Sld_700_Lee_ARMOR_Info()
{
	...
	AI_Output(self,other,"Sld_700_Lee_ARMOR_Info_08_02");	//Ты прежде должен его заслужить. Не говоря уже о том, что хороший доспех стоит недешево.
...
func void Sld_700_Lee_ARMOR_M()
{
	...
	{
		AI_Output(self,other,"Sld_700_Lee_ARMOR_M_Info_08_04");	//Это добрый доспех. Он надежно защитит тебя.
...
func void Sld_700_Lee_ARMOR_H()
{
	...
	{
		AI_Output(self,other,"Sld_700_Lee_ARMOR_H_Info_08_04");	//Этот доспех - лучший из тех, что можно отыскать внутри Барьера. И поверь мне, он стоит каждого потраченного самородка.
