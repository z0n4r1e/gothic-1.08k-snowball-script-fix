...
func void DIA_Fletcher_WegenNek_Info()
{
	...
	if((Sly_LostNek == LOG_SUCCESS) || !Hlp_IsValidNpc(Nek))
	{
		...
		AI_Output(self,other,"DIA_Fletcher_WegenNek_06_05");	//О, нет! Проклятье! Значит, теперь я останусь здесь насовсем. А я так надеялся, что он вернется!
