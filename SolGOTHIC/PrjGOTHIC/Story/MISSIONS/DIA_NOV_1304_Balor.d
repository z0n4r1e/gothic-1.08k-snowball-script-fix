...
func void DIA_Balor_FetchWeed_Info()
{
	...
	AI_Output(self,other,"DIA_Balor_FetchWeed_01_03");	//В противном случае кое-кому дневной сбор может показаться слишком маленьким, и кое-кто может даже подумать, что ты продал половину. Хе-хе хе-хе!
...
func void DIA_Balor_SellUnder_Info()
{
	...
	Info_AddChoice(DIA_Balor_SellUnder,"Если ты знаешь нужного человека, мы могли бы поделить деньги поровну.",DIA_Balor_SellUnder_HalfHalf);
...
instance DIA_Balor_TellDealer(C_Info)
{
	...
	permanent = 1;
	description = "...Кому в Новом Лагере нужен болотник?";
};
...
instance DIA_Balor_RipOff(C_Info)
{
	...
	permanent = 0;
	description = "...Я вернулся за следующей партией.";
};
...
func void DIA_Balor_Perm_Info()
{
	...
	AI_Output(self,other,"DIA_Balor_Perm_01_01");	//А чем, по-твоему, я занимаюсь? Просиживаю задницу?
};
