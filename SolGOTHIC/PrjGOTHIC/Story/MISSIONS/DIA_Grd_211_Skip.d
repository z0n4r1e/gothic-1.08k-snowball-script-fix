...
func void DIA_Skip_First_Info()
{
	...
	Info_AddChoice(DIA_Skip_First,"Все ясно.",DIA_Skip_First_BACK);
	Info_AddChoice(DIA_Skip_First,"Меня прислал Торус.",DIA_Skip_First_Thorus);
...
func void DIA_Skip_First_Thorus()
{
	...
	Info_AddChoice(DIA_Skip_First,"Он велел пинать твою тощую задницу...",DIA_Skip_First_Thorus_KickAss);
...
func void DIA_Skip_First_Thorus_Stranger()
{
	...
	Info_ClearChoices(DIA_Skip_First);
	Info_AddChoice(DIA_Skip_First,"Почему бы тебе самому не спросить его? ",DIA_Skip_First_Thorus_AskHim);
	Info_AddChoice(DIA_Skip_First,"Он велел пинать твою тощую задницу...",DIA_Skip_First_Thorus_KickAssAGAIN);
};
...
instance DIA_Skip_VERPATZT(C_Info)
{
	...
	permanent = 1;
	description = "...мне стоит вернуться и посоветоваться по поводу снаряжения...";
};
