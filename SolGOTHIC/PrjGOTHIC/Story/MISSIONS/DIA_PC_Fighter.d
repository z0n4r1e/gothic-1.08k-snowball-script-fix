...
func void Dia_Gorn_Leben_Info()
{
	...
	AI_Output(self,other,"DIA_Gorn_Leben_09_03");	//Маги должны позаботиться о том, чтобы рано или поздно мы все смогли убраться отсюда. А еще мы получаем малую толику руды в качестве платы за службу. 
};
...
instance DIA_Gorn_BecomeSLD(C_Info)
{
	...
	permanent = 0;
	description = "...присоединиться к Новому Лагерю?";
};
...
instance DIA_Gorn_TRADE(C_Info)
{
	...
	permanent = 1;
	description = "Сколько у тебя этого добра?";
	trade = 1;
};
...
func void Info_Gorn_NCWAIT_Info()
{
	...
	AI_Output(self,other,"Info_Gorn_NCWAIT_09_01");	//А-а, это ты! Мой друг Лестер из Лагеря на Болотах рассказал мне о твоих подвигах.
...
instance Info_Gorn_KICKBUTT(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "Ладно, пойдем покажем непрошенным гостям...";
};
...
instance Info_Gorn_MYWAY(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "...Мне же все равно нужно попасть в шахту!";
};
