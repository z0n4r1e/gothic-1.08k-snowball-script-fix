...
func void GUR_1202_CorAngar_WANNABETPL_Info()
{
	...
	else if(hero.level >= 10)
	{
		...
		AI_Output(self,other,"GUR_1202_CorAngar_WANNABETPL_Info_08_06");	//Я искренне рад тому, что ты добился столь впечатляющих результатов за столь короткое время. Теперь ты готов стать одним из нас.
		...
		AI_Output(self,other,"GUR_1202_CorAngar_WANNABETPL_Info_08_08");	//Отправляйся к Гор На Тофу на тренировочную площадку. Он даст тебе новый доспех.
...
func void GUR_1202_CorAngar_ZWEIHAND2_Info()
{
	...
	if(B_GiveSkill(other,NPC_TALENT_2H,2,LPCOST_TALENT_2H_2))
	{
		...
		AI_Output(self,other,"GUR_1202_CorAngar_ZWEIHAND2_Info_08_04");	//Если ты знаешь, как дернется твой враг, то ты уже наполовину победил.
