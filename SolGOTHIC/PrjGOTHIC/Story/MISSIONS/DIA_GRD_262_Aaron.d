...
func void GRD_262_Aaron_BLUFF_Info()
{
	...
	Info_AddChoice(GRD_262_Aaron_BLUFF,"Меня прислал Ян.",GRD_262_Aaron_BLUFF_IAN);
...
func void GRD_262_Aaron_BLUFF_IAN()
{
	...
	Info_AddChoice(GRD_262_Aaron_BLUFF,"Он накажет тебя за твою лень.",GRD_262_Aaron_BLUFF_BAD);
	Info_AddChoice(GRD_262_Aaron_BLUFF,"Он хочет наградить тебя за хорошую работу.",GRD_262_Aaron_BLUFF_GOOD);
};
...
instance GRD_262_Aaron_SELL(C_Info)
{
	...
	important = 0;
	permanent = 0;
	description = "Эй, ты ничего не потерял?";
};
