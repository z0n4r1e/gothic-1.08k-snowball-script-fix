...
instance DIA_Harlok_HarlokAgain(C_Info)
{
	...
	permanent = 0;
	description = "Я просто хотел напомнить тебе...";
};
...
{
	AI_Output(other,self,"DIA_Harlok_HarlokAgain_15_00");	//Я просто хотел напомнить тебе, что ты должен сменить своего товарища!
