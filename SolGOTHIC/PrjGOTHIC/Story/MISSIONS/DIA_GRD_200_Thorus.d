...
func void Info_Thorus_DiegoSentMe_Info()
{
	...
	AI_Output(self,other,"Info_Thorus_DiegoSentMe_09_01");	//Пхы... Если Диего считает, что ты нам подходишь, почему он САМ не занимается тобой?
...
{
	var C_Npc Mordrag;
	AI_Output(other,self,"Info_Thorus_MordragKo_About_15_00");	//По поводу Мордрага...
...
instance Info_Thorus_BribeGuard(C_Info)
{
	...
	permanent = 0;
	description = "Если бы я поделился с тобой своим запасом руды...";
};
...
instance Info_Thorus_Give1000Ore(C_Info)
{
	...
	permanent = 1;
	description = "У меня есть тысяча кусков руды.";
};
...
func void Info_Thorus_Give1000Ore_Info()
{
	...
	if(Npc_HasItems(other,ItMiNugget) >= 1000)
	{
		...
		wache212.aivar[AIV_PASSGATE] = 1;
		wache213.aivar[AIV_PASSGATE] = 1;
	}
	else
	{
...
func void Info_Thorus_ReadyForGomez_Info()
{
	...
	AI_Output(self,other,"Info_Thorus_ReadyForGomez_09_03");	//Ххыыы...
...
func void Info_Thorus_Krautbote_Info()
{
	...
	{
		AI_Output(self,other,"Info_Thorus_Krautbote_09_02");	//Мхх-гммм...
...
instance Info_Thorus_KdWSiegel(C_Info)
{
	...
	permanent = 1;
	description = "Я по поручению магов Воды.";
};
...
instance Info_Thorus_SttGeschafft(C_Info)
{
	...
	permanent = 0;
	description = "...Теперь я принадлежу к этому Лагерю!";
};
...
instance GRD_200_Thorus_Teach(C_Info)
{
	...
	permanent = 1;
	description = "Ты будешь учить меня?";
};
