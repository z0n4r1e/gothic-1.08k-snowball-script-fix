...
func void DIA_BaalTyon_NoTalk_Info()
{
	...
	{
		Info_AddChoice(DIA_BaalTyon_NoTalk,"...Примите сей скромный дар...",DIA_BaalTyon_SpecialJoint);
	};
...
func void DIA_BaalTyon_NoTalk_Hi()
{
	...
	AI_Output(self,other,"DIA_BaalTyon_NoTalk_Hi_11_01");	//Оооох...
	BaalTyon_Sakrileg = 1;
};
...
func void DIA_BaalTyon_NoTalk_Sleeper()
{
	...
	AI_Output(self,other,"DIA_BaalTyon_NoTalk_Sleeper_11_01");	//Оооох...
	BaalTyon_Sakrileg = 1;
};
...
func void DIA_BaalTyon_NoTalk_Imp()
{
	...
	AI_Output(self,other,"DIA_BaalTyon_NoTalk_Imp_11_01");	//Оооох...
	BaalTyon_Sakrileg = 1;
};
...
func void DIA_BaalTyon_SpecialJoint()
{
	...
	AI_Output(self,other,"DIA_BaalTyon_SpecialJoint_11_01");	//Ммммммм... Ухх...
