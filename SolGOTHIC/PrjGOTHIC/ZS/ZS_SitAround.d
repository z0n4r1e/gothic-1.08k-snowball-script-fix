...
func void ZS_SitAround()
{
	...
	{
		PrintDebugNpc(PD_TA_CHECK,"...слишком далеко от Начальной Точки TA!");
		AI_Standup(self);
...
func int ZS_SitAround_Loop()
{
	...
	if(!C_BodyStateContains(self,BS_SIT))
	{
		...
		{
			PrintDebugNpc(PD_TA_CHECK,"...Места не найдено!");
	...
	else
	{
		...
		PrintDebugInt(PD_TA_DETAIL,"...Анимация Случайного Броска: ",sitreaktion);
		if(sitreaktion >= 95)
		{
			B_Pee(self);
		}
