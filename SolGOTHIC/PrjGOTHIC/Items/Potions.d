...
instance ItFo_Potion_Mana_02(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "¬ыт€жка магической энергии";
	text[1] = NAME_Bonus_Mana;
...
instance ItFo_Potion_Mana_03(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "Ёликсир магической энергии";
	text[1] = NAME_Bonus_Mana;
...
instance ItFo_Potion_Elixier_Egg(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "Ёликсир ползуна";
	text[0] = "ѕозвол€ет вступить в контакт со —п€щим.";
...
instance ItFo_Potion_Master_01(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "Ёликсир могущества";
	text[1] = NAME_Bonus_Dex;
...
instance ItFo_Potion_Master_02(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "Ёликсир превосходства";
	text[1] = NAME_Bonus_Dex;
...
instance ItFo_Potion_Haste_01(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "Ёликсир проворства";
