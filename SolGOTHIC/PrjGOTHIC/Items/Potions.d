...
instance ItFo_Potion_Mana_01(C_Item)
{
	...
	description = "Ёссенци€ ћагической Ёнергии";
...
instance ItFo_Potion_Mana_02(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "Ёкстракт ћагической Ёнергии";
	text[1] = NAME_Bonus_Mana;
...
instance ItFo_Potion_Mana_03(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "Ёликсир ћагической Ёнергии";
	text[1] = NAME_Bonus_Mana;
...
instance ItFo_Potion_Health_01(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "Ёссенци€ ÷елительной —илы";
...
instance ItFo_Potion_Health_02(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "Ёкстракт ÷елительной —илы";
	text[1] = NAME_Bonus_HP;
	count[1] = HP_Extrakt;
	text[5] = NAME_Value;
...
instance ItFo_Potion_Health_03(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "Ёликсир ÷елительной —илы";
	text[1] = NAME_Bonus_HP;
	count[1] = HP_Elixier;
	text[5] = NAME_Value;
...
instance ItFo_Potion_Elixier_Egg(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "Ёликсир ѕолзуна";
	text[0] = "позвол€ет вступить в  онтакт со —п€щим.";
...
func void UseNectarPotion()
{
	...
	PrintDebugNpc(PD_ITEM_MOBSI,"я пью ћагию");
};
...
instance ItFo_Potion_Haste_01(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "«елье —корости";
	text[1] = "ѕозвол€ет бежать быстро, но не долго.";
...
func void UseHastePotion()
{
	...
	PrintDebugNpc(PD_ITEM_MOBSI,"теперь € двигаюсь быстро");
};
...
instance ItFo_Potion_Haste_02(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "Ёликсир Ѕыстроты";
	text[1] = "ѕозвол€ет бежать быстро.";
	text[3] = NAME_Duration;
...
instance ItFo_Potion_Haste_03(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "«елье —уеты";
	text[1] = "ѕозвол€ет бежать быстро и долго.";
	text[3] = NAME_Duration;
