...
instance Schutzring_Feuer1(C_Item)
{
	...
	description = "Кольцо Пламенной Защиты";
...
instance Schutzring_Feuer2(C_Item)
{
	...
	description = "Кольцо Огненной Защиты";
	text[2] = NAME_Prot_Fire;
	count[2] = 5;
	text[5] = NAME_Value;
	count[5] = value;
...
instance Schutzring_Geschosse2_Waffen2(C_Item)
{
	...
	description = "Кольцо Неприступности";
	text[2] = NAME_Prot_Edge;
	count[2] = 10;
	text[3] = NAME_Prot_Point;
	count[3] = 10;
...
instance Schutzring_Total1(C_Item)
{
	...
	description = "Кольцо Непреодолимости";
