...
instance ItArRuneTeleport3(C_Item)
{
	...
	material = MAT_STONE;
	spell = SPL_Teleport3;
	description = "Портал Повелителя Демонов";
	text[0] = NAME_Mag_Circle;
	count[0] = mag_circle;
	text[1] = NAME_Manakosten;
	count[1] = SPL_SENDCAST_TELEPORT;
...
instance ItArRuneTeleport5(C_Item)
{
	...
	material = MAT_STONE;
	spell = SPL_Teleport5;
	description = "Портал Болотнх Гуру";
	text[0] = NAME_Mag_Circle;
	count[0] = mag_circle;
	text[1] = NAME_Manakosten;
	count[1] = SPL_SENDCAST_TELEPORT;
...
instance ItArScrollTeleport5(C_Item)
{
	...
	cond_atr[2] = ATR_MANA_MAX;
	cond_value[2] = SPL_SENDCAST_TELEPORT;
	description = "Портал Болотных Гуру";
	text[1] = NAME_Manakosten;
	count[1] = SPL_SENDCAST_TELEPORT;
};
...
instance ItArScrollTrfBloodfly(C_Item)
{
	...
	description = "Превращение: Шершень";
	text[1] = NAME_Manakosten;
...
instance ItArScrollTrfCrawler(C_Item)
{
	...
	description = "Превращение: Ползун";
	text[1] = NAME_Manakosten;
...
instance ItArScrollTrfMeatbug(C_Item)
{
	...
	description = "Превращение: Мясной Жук";
	text[1] = NAME_Manakosten;
...
instance ItArScrollTrfMolerat(C_Item)
{
	...
	description = "Превращение: Кротокрыс";
	text[1] = NAME_Manakosten;
...
instance ItArScrollTrfOrcdog(C_Item)
{
	...
	description = "Превращение: Орочья Гончая";
	text[1] = NAME_Manakosten;
...
instance ItArScrollTrfScavenger(C_Item)
{
	...
	description = "Превращение: Падальщик";
	text[1] = NAME_Manakosten;
...
instance ItArScrollTrfShadowbeast(C_Item)
{
	...
	description = "Превращение: Мракорис";
	text[1] = NAME_Manakosten;
...
instance ItArScrollTrfWaran(C_Item)
{
	...
	description = "Превращение: Ящерица";
	text[1] = NAME_Manakosten;
