...
const int Value_Käse = 10;
const int HP_Käse = 15;
...
const int Value_Höllenpilz = 3;
const int HP_Höllenpilz = 6;
const int Value_Sklavenbrot = 9;
const int HP_Sklavenbrot = 15;
const int Value_Heilkräuter1 = 14;
const int HP_Heilkräuter1 = 30;
const int Value_Heilkräuter2 = 19;
const int HP_Heilkräuter2 = 39;
const int Value_Heilkräuter3 = 24;
const int HP_Heilkräuter3 = 49;
...
instance ItFo_Plants_mushroom_01(C_Item)
{
	...
	description = name;
	text[1] = NAME_Bonus_HP;
	count[1] = HP_Höllenpilz;
	text[5] = NAME_Value;
	count[5] = Value_Höllenpilz;
};
...
instance ItFo_Plants_Herb_01(C_Item)
{
	...
	description = name;
	text[1] = NAME_Bonus_HP;
	count[1] = HP_Heilkräuter1;
	text[5] = NAME_Value;
	count[5] = Value_Heilkräuter1;
};
...
instance ItFo_Plants_Herb_02(C_Item)
{
	...
	description = name;
	text[1] = NAME_Bonus_HP;
	count[1] = HP_Heilkräuter2;
	text[5] = NAME_Value;
	count[5] = Value_Heilkräuter2;
};
...
instance ItFo_Plants_Herb_03(C_Item)
{
	...
	description = name;
	text[1] = NAME_Bonus_HP;
	count[1] = HP_Heilkräuter3;
	text[5] = NAME_Value;
	count[5] = Value_Heilkräuter3;
};
