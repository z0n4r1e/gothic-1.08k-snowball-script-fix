...
instance HANDSAW(C_SFX_DEF)
{
	file = "handsaw_01.wav";
	vol = 20;
};

instance HANDSAW_A1(C_SFX_DEF)
{
	file = "handsaw_02.wav";
	vol = 20;
};

instance STONE_WORK(C_SFX_DEF)
{
	file = "stone_work_01.wav";
	vol = 70;
};

instance STONE_WORK_A1(C_SFX_DEF)
{
	file = "stone_work_02.wav";
	vol = 70;
};

instance STONE_WORK_A2(C_SFX_DEF)
{
	file = "stone_work_03.wav";
	vol = 70;
};

instance STONE_WORK_A3(C_SFX_DEF)
{
	file = "stone_work_04.wav";
	vol = 70;
};

instance ARROW_CARVE(C_SFX_DEF)
{
	file = "arrow_carve_01.wav";
	vol = 20;
};

instance ARROW_CARVE_A1(C_SFX_DEF)
{
	file = "arrow_carve_02.wav";
	vol = 20;
};

instance ARROW_CARVE_A2(C_SFX_DEF)
{
	file = "arrow_carve_03.wav";
	vol = 20;
};

instance ARROW_CARVE_A3(C_SFX_DEF)
{
	file = "arrow_carve_04.wav";
	vol = 20;
};

instance MELTER_DOOR1(C_SFX_DEF)
{
	file = "melter_door_01.wav";
	vol = 100;
};

instance MELTER_DOOR2(C_SFX_DEF)
{
	file = "melter_door_02.wav";
	vol = 80;
};

instance MELTER_FIRE(C_SFX_DEF)
{
	file = "melter_door_03.wav";
	vol = 90;
};

instance BOWBEND(C_SFX_DEF)
{
	file = "bowbend_01.wav";
	vol = 50;
};

instance BOWCLICK(C_SFX_DEF)
{
	file = "bowclick_01.wav";
	vol = 30;
};

instance RUNE_CAST(C_SFX_DEF)
{
	file = "runemaker_cast.wav";
	vol = 40;
};

instance RUNE_FLANGE(C_SFX_DEF)
{
	file = "runemaker_flange.wav";
	vol = 50;
};

instance RUNE_WINE(C_SFX_DEF)
{
	file = "runemaker_wine.wav";
	vol = 60;
};

instance RUNE_METAL(C_SFX_DEF)
{
	file = "runemaker_metal.wav";
	vol = 65;
};

instance RUNE_METAL_SHORT(C_SFX_DEF)
{
	file = "runemaker_metal_short.wav";
	vol = 65;
};
...
instance DEM_DEM_AMBIENT(C_SFX_DEF)
{
	file = "DEM_DEM_Ambient01.wav";
	vol = 60;
};

instance DEM_DEM_AMBIENT_A1(C_SFX_DEF)
{
	file = "DEM_DEM_Ambient02.wav";
	vol = 60;
};

instance DEM_DEM_AMBIENT_A2(C_SFX_DEF)
{
	file = "DEM_DEM_Ambient03.wav";
	vol = 60;
};

instance DEM_DEM_AMBIENT_A3(C_SFX_DEF)
{
	file = "DEM_DEM_Ambient04.wav";
	vol = 60;
};

instance DEM_DEM_AMBIENT_A4(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance DEM_DEM_AMBIENT_A5(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance DEM_DEM_AMBIENT_A6(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance DEM_DEM_AMBIENT_A7(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance DEM_DEM_AMBIENT_A8(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance DEM_DEM_AMBIENT_A9(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance DEM_DEM_ATTACK(C_SFX_DEF)
{
	file = "DEM_DEM_Attack01.wav";
	vol = 100;
};

instance DEM_DEM_ATTACK_A1(C_SFX_DEF)
{
	file = "DEM_DEM_Attack02.wav";
	vol = 100;
};

instance DEM_DEM_DIE(C_SFX_DEF)
{
	file = "DEM_DEM_Die01.wav";
	vol = 110;
};

instance DEM_DEM_DIE_A1(C_SFX_DEF)
{
	file = "DEM_DEM_Die02.wav";
	vol = 110;
};

instance DEM_DEM_HURT(C_SFX_DEF)
{
	file = "DEM_DEM_Hurt01.wav";
	vol = 90;
};

instance DEM_DEM_WARN(C_SFX_DEF)
{
	file = "DEM_DEM_Warn01.wav";
	vol = 110;
};

instance DEM_DEM_WINGFLAP(C_SFX_DEF)
{
	file = "DEM_DEM_Wingflap01.wav";
	vol = 50;
};

instance DEM_DEM_WINGFLAP_A1(C_SFX_DEF)
{
	file = "DEM_DEM_Wingflap02.wav";
	vol = 50;
};

instance DEM_DEM_WINGFLAP_A2(C_SFX_DEF)
{
	file = "DEM_DEM_Wingflap03.wav";
	vol = 50;
};
...
instance SCA_DEM_AMBIENT_SHORT(C_SFX_DEF)
{
	file = "SCA_DEM_Ambient_Short01.wav";
	vol = 50;
};

instance SCA_DEM_AMBIENT_SHORT_A1(C_SFX_DEF)
{
	file = "SCA_DEM_Ambient_Short02.wav";
	vol = 50;
};

instance SCA_DEM_AMBIENT_SHORT_A2(C_SFX_DEF)
{
	file = "SCA_DEM_Ambient_Short03.wav";
	vol = 50;
};

instance SCA_DEM_AMBIENT_SHORT_A3(C_SFX_DEF)
{
	file = "SCA_DEM_Ambient_Short04.wav";
	vol = 50;
};

instance SCA_DEM_AMBIENT_SHORT_A4(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SCA_DEM_AMBIENT_SHORT_A5(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SCA_DEM_AMBIENT_SHORT_A6(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SCA_DEM_AMBIENT_SHORT_A7(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SCA_DEM_ATTACK(C_SFX_DEF)
{
	file = "SCA_DEM_Attack01.wav";
	vol = 75;
};

instance SCA_DEM_ATTACK_A1(C_SFX_DEF)
{
	file = "SCA_DEM_Attack02.wav";
	vol = 75;
};

instance SCA_DEM_DIE(C_SFX_DEF)
{
	file = "SCA_DEM_Die01.wav";
	vol = 50;
};

instance SCA_DEM_DIE_A1(C_SFX_DEF)
{
	file = "SCA_DEM_Die02.wav";
	vol = 50;
};

instance SCA_DEM_FLY(C_SFX_DEF)
{
	file = "SCA_DEM_Fly01.wav";
	vol = 35;
};

instance SCA_DEM_GACKER(C_SFX_DEF)
{
	file = "SCA_DEM_Gacker01.wav";
	vol = 75;
};

instance SCA_DEM_HURT(C_SFX_DEF)
{
	file = "SCA_DEM_Hurt01.wav";
	vol = 75;
};

instance SCA_DEM_HURT_A1(C_SFX_DEF)
{
	file = "SCA_DEM_Hurt02.wav";
	vol = 75;
};

instance SCA_DEM_HURT_A2(C_SFX_DEF)
{
	file = "SCA_DEM_Hurt03.wav";
	vol = 75;
};

instance SCA_DEM_SHAKEHEAD(C_SFX_DEF)
{
	file = "SCA_DEM_Shakehead01.wav";
	vol = 75;
};

instance SCA_DEM_SLURPDOWN(C_SFX_DEF)
{
	file = "SCA_DEM_Slurp01.wav";
	vol = 75;
};

instance SCA_DEM_WARN(C_SFX_DEF)
{
	file = "SCA_DEM_Warn01.wav";
	vol = 95;
};
...
instance SHA_DEM_AMBIENT(C_SFX_DEF)
{
	file = "SHA_DEM_Ambient01.wav";
	vol = 50;
};

instance SHA_DEM_AMBIENT_A1(C_SFX_DEF)
{
	file = "SHA_DEM_Ambient02.wav";
	vol = 50;
};

instance SHA_DEM_AMBIENT_A2(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SHA_DEM_AMBIENT_A3(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SHA_DEM_AMBIENT_SHORT(C_SFX_DEF)
{
	file = "SHA_DEM_Ambient_Short01.wav";
	vol = 50;
};

instance SHA_DEM_AMBIENT_SHORT_A1(C_SFX_DEF)
{
	file = "SHA_DEM_Ambient_Short02.wav";
	vol = 50;
};

instance SHA_DEM_AMBIENT_SHORT_A2(C_SFX_DEF)
{
	file = "SHA_DEM_Ambient_Short03.wav";
	vol = 50;
};

instance SHA_DEM_AMBIENT_SHORT_A3(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SHA_DEM_AMBIENT_SHORT_A4(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SHA_DEM_AMBIENT_SHORT_A5(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SHA_DEM_ATTACK(C_SFX_DEF)
{
	file = "SHA_DEM_Attack01.wav";
	vol = 100;
};

instance SHA_DEM_ATTACK_A1(C_SFX_DEF)
{
	file = "SHA_DEM_Attack02.wav";
	vol = 100;
};

instance SHA_DEM_ATTACK_A2(C_SFX_DEF)
{
	file = "SHA_DEM_Attack03.wav";
	vol = 100;
};

instance SHA_DEM_ATTACK_A3(C_SFX_DEF)
{
	file = "SHA_DEM_Attack04.wav";
	vol = 100;
};

instance SHA_DEM_DIE(C_SFX_DEF)
{
	file = "SHA_DEM_Die01.wav";
	vol = 127;
};

instance SHA_DEM_HURT(C_SFX_DEF)
{
	file = "SHA_DEM_Hurt01.wav";
	vol = 100;
};

instance SHA_DEM_HURT_A1(C_SFX_DEF)
{
	file = "SHA_DEM_Hurt02.wav";
	vol = 100;
};

instance SHA_DEM_HURT_A2(C_SFX_DEF)
{
	file = "SHA_DEM_Hurt03.wav";
	vol = 100;
};

instance SHA_DEM_SNOREIN(C_SFX_DEF)
{
	file = "SHA_DEM_Snorein01.wav";
	vol = 60;
};

instance SHA_DEM_SNOREOUT(C_SFX_DEF)
{
	file = "SHA_DEM_Snoreout01.wav";
	vol = 60;
};

instance SHA_DEM_WARN(C_SFX_DEF)
{
	file = "SHA_DEM_Warn01.wav";
	vol = 127;
};

instance SHA_DEM_WARN_A1(C_SFX_DEF)
{
	file = "SHA_DEM_Warn02.wav";
	vol = 127;
};
...
instance SKE_AMBIENT_A3(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SKE_AMBIENT_A4(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SKE_AMBIENT_A5(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SKE_AMBIENT_A6(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};
...
instance SNA_DEM_AMBIENT(C_SFX_DEF)
{
	file = "SNA_DEM_Ambient01.wav";
	vol = 50;
};

instance SNA_DEM_AMBIENT_A1(C_SFX_DEF)
{
	file = "SNA_DEM_Ambient02.wav";
	vol = 50;
};

instance SNA_DEM_AMBIENT_A2(C_SFX_DEF)
{
	file = "SNA_DEM_Ambient03.wav";
	vol = 50;
};

instance SNA_DEM_AMBIENT_A3(C_SFX_DEF)
{
	file = "SNA_DEM_Ambient02.wav";
	vol = 50;
};

instance SNA_DEM_AMBIENT_A4(C_SFX_DEF)
{
	file = "SNA_DEM_Ambient04.wav";
	vol = 50;
};

instance SNA_DEM_AMBIENT_A5(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SNA_DEM_AMBIENT_A6(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SNA_DEM_AMBIENT_A7(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SNA_DEM_AMBIENT_A8(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SNA_DEM_AMBIENT_A9(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SNA_DEM_AMBIENT_A10(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SNA_DEM_AMBIENT_A11(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SNA_DEM_AMBIENT_SHORT(C_SFX_DEF)
{
	file = "SNA_DEM_Ambient_Short01.wav";
	vol = 30;
};

instance SNA_DEM_AMBIENT_SHORT_A1(C_SFX_DEF)
{
	file = "SNA_DEM_Ambient_Short02.wav";
	vol = 30;
};

instance SNA_DEM_AMBIENT_SHORT_A2(C_SFX_DEF)
{
	file = "SNA_DEM_Ambient_Short03.wav";
	vol = 30;
};

instance SNA_DEM_AMBIENT_SHORT_A3(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SNA_DEM_AMBIENT_SHORT_A4(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SNA_DEM_AMBIENT_SHORT_A5(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SNA_DEM_AMBIENT_SHORT_A6(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SNA_DEM_AMBIENT_SHORT_A7(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance SNA_DEM_ATTACK(C_SFX_DEF)
{
	file = "SNA_DEM_Attack01.wav";
	vol = 85;
};

instance SNA_DEM_ATTACK_A1(C_SFX_DEF)
{
	file = "SNA_DEM_Attack02.wav";
	vol = 85;
};

instance SNA_DEM_CLEAN(C_SFX_DEF)
{
	file = "SNA_DEM_Clean01.wav";
	vol = 100;
};

instance SNA_DEM_DIE(C_SFX_DEF)
{
	file = "SNA_DEM_Die01.wav";
	vol = 80;
};

instance SNA_DEM_HAPPY(C_SFX_DEF)
{
	file = "SNA_DEM_Happy01.wav";
	vol = 100;
};

instance SNA_DEM_HURT(C_SFX_DEF)
{
	file = "SNA_DEM_Hurt01.wav";
	vol = 110;
};

instance SNA_DEM_HURT_A1(C_SFX_DEF)
{
	file = "SNA_DEM_Hurt02.wav";
	vol = 110;
};

instance SNA_DEM_WARN(C_SFX_DEF)
{
	file = "SNA_DEM_Warn01.wav";
	vol = 110;
};

instance SNA_DEM_WARN_A1(C_SFX_DEF)
{
	file = "SNA_DEM_Warn02.wav";
	vol = 110;
};
...
instance TRO_DEM_AMBIENT(C_SFX_DEF)
{
	file = "TRO_DEM_Ambient01.wav";
	vol = 110;
};

instance TRO_DEM_AMBIENT_A1(C_SFX_DEF)
{
	file = "TRO_DEM_Ambient02.wav";
	vol = 110;
};

instance TRO_DEM_AMBIENT_A2(C_SFX_DEF)
{
	file = "TRO_DEM_Ambient03.wav";
	vol = 110;
};

instance TRO_DEM_AMBIENT_A3(C_SFX_DEF)
{
	file = "TRO_DEM_Ambient04.wav";
	vol = 110;
};

instance TRO_DEM_AMBIENT_A4(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance TRO_DEM_AMBIENT_A5(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance TRO_DEM_AMBIENT_A6(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance TRO_DEM_AMBIENT_A7(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance TRO_DEM_ATTACK(C_SFX_DEF)
{
	file = "TRO_DEM_Attack01.wav";
	vol = 125;
};

instance TRO_DEM_DIE(C_SFX_DEF)
{
	file = "TRO_DEM_Die01.wav";
	vol = 125;
};

instance TRO_DEM_FISTWOOSH(C_SFX_DEF)
{
	file = "TRO_DEM_Fistwoosh01.wav";
	vol = 125;
};

instance TRO_DEM_GROWL(C_SFX_DEF)
{
	file = "TRO_DEM_Growl01.wav";
	vol = 125;
};

instance TRO_DEM_GROWL_A1(C_SFX_DEF)
{
	file = "TRO_DEM_Growl02.wav";
	vol = 125;
};

instance TRO_DEM_HURT(C_SFX_DEF)
{
	file = "TRO_DEM_Hurt01.wav";
	vol = 125;
};

instance TRO_DEM_PERCEPTION(C_SFX_DEF)
{
	file = "TRO_DEM_Perception01.wav";
	vol = 125;
};

instance TRO_DEM_SNORE(C_SFX_DEF)
{
	file = "TRO_DEM_Snore01.wav";
	vol = 125;
};

instance TRO_DEM_STEPBOOM(C_SFX_DEF)
{
	file = "TRO_DEM_Stepboom01.wav";
	vol = 125;
};

instance TRO_DEM_STEPLIGHT(C_SFX_DEF)
{
	file = "TRO_DEM_Stepboom01.wav";
	vol = 50;
};

instance TRO_DEM_WARN(C_SFX_DEF)
{
	file = "TRO_DEM_Warn01.wav";
	vol = 127;
};
...
instance WAR_DEM_AMBIENT(C_SFX_DEF)
{
	file = "WAR_DEM_Ambient01.wav";
	vol = 100;
};

instance WAR_DEM_AMBIENT_A1(C_SFX_DEF)
{
	file = "WAR_DEM_Ambient02.wav";
	vol = 100;
};

instance WAR_DEM_AMBIENT_A2(C_SFX_DEF)
{
	file = "WAR_DEM_Ambient03.wav";
	vol = 100;
};

instance WAR_DEM_AMBIENT_A3(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance WAR_DEM_AMBIENT_A4(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance WAR_DEM_AMBIENT_A5(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance WAR_DEM_AMBIENT_SHORT(C_SFX_DEF)
{
	file = "WAR_DEM_Ambient_Short01.wav";
	vol = 100;
};

instance WAR_DEM_AMBIENT_SHORT_A1(C_SFX_DEF)
{
	file = "WAR_DEM_Ambient_Short02.wav";
	vol = 100;
};

instance WAR_DEM_AMBIENT_SHORT_A2(C_SFX_DEF)
{
	file = "WAR_DEM_Ambient_Short03.wav";
	vol = 100;
};

instance WAR_DEM_AMBIENT_SHORT_A3(C_SFX_DEF)
{
	file = "WAR_DEM_Ambient_Short04.wav";
	vol = 100;
};

instance WAR_DEM_AMBIENT_SHORT_A4(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance WAR_DEM_AMBIENT_SHORT_A5(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance WAR_DEM_AMBIENT_SHORT_A6(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance WAR_DEM_AMBIENT_SHORT_A7(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance WAR_DEM_ATTACK(C_SFX_DEF)
{
	file = "WAR_DEM_Attack01.wav";
	vol = 100;
};

instance WAR_DEM_ATTACK_A1(C_SFX_DEF)
{
	file = "WAR_DEM_Attack01.wav";
	vol = 100;
};

instance WAR_DEM_DIE(C_SFX_DEF)
{
	file = "WAR_DEM_Die01.wav";
	vol = 100;
};

instance WAR_DEM_HURT(C_SFX_DEF)
{
	file = "WAR_DEM_Hurt01.wav";
	vol = 100;
};

instance WAR_DEM_HURT_A1(C_SFX_DEF)
{
	file = "WAR_DEM_Hurt02.wav";
	vol = 100;
};

instance WAR_DEM_WARN(C_SFX_DEF)
{
	file = "WAR_DEM_Warn01.wav";
	vol = 127;
};

instance WAR_DEM_WARN_A1(C_SFX_DEF)
{
	file = "WAR_DEM_Warn02.wav";
	vol = 127;
};

instance FWA_DEM_ATTACK(C_SFX_DEF)
{
	file = "FWA_DEM_Attack01.wav";
	vol = 100;
};

instance FWA_DEM_ATTACK_A1(C_SFX_DEF)
{
	file = "FWA_DEM_Attack01.wav";
	vol = 100;
};
...
instance WOL_DEM_AMBIENT(C_SFX_DEF)
{
	file = "WOL_DEM_Ambient01.wav";
	vol = 55;
};

instance WOL_DEM_AMBIENT_A1(C_SFX_DEF)
{
	file = "WOL_DEM_Ambient02.wav";
	vol = 55;
};

instance WOL_DEM_AMBIENT_A2(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance WOL_DEM_AMBIENT_A3(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance WOL_DEM_AMBIENT_A4(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance WOL_DEM_AMBIENT_SHORT(C_SFX_DEF)
{
	file = "WOL_DEM_Ambient_Short01.wav";
	vol = 35;
};

instance WOL_DEM_AMBIENT_SHORT_A1(C_SFX_DEF)
{
	file = "WOL_DEM_Ambient_Short02.wav";
	vol = 35;
};

instance WOL_DEM_AMBIENT_SHORT_A2(C_SFX_DEF)
{
	file = "WOL_DEM_Ambient_Short03.wav";
	vol = 35;
};

instance WOL_DEM_AMBIENT_SHORT_A3(C_SFX_DEF)
{
	file = "WOL_DEM_Ambient_Short04.wav";
	vol = 35;
};

instance WOL_DEM_AMBIENT_SHORT_A4(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance WOL_DEM_AMBIENT_SHORT_A5(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance WOL_DEM_AMBIENT_SHORT_A6(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance WOL_DEM_AMBIENT_SHORT_A7(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance WOL_DEM_ATTACK(C_SFX_DEF)
{
	file = "WOL_DEM_Attack01.wav";
	vol = 112;
};

instance WOL_DEM_ATTACK_A1(C_SFX_DEF)
{
	file = "WOL_DEM_Attack02.wav";
	vol = 112;
};

instance WOL_DEM_DIE(C_SFX_DEF)
{
	file = "WOL_DEM_Die01.wav";
	vol = 120;
};

instance WOL_DEM_GROWL(C_SFX_DEF)
{
	file = "WOL_DEM_Growl01.wav";
	vol = 95;
};

instance WOL_DEM_HURT(C_SFX_DEF)
{
	file = "WOL_DEM_Hurt01.wav";
	vol = 55;
};

instance WOL_DEM_HURT_A1(C_SFX_DEF)
{
	file = "WOL_DEM_Hurt02.wav";
	vol = 55;
};

instance WOL_DEM_HURT_A2(C_SFX_DEF)
{
	file = "WOL_DEM_Hurt03.wav";
	vol = 55;
};

instance WOL_DEM_WARN(C_SFX_DEF)
{
	file = "WOL_DEM_Warn01.wav";
	vol = 85;
};
...
instance ARENAHORN_01(C_SFX_DEF)
{
	file = "arenahorn_01.wav";
	vol = 127;
};

instance ARENAHORN_02(C_SFX_DEF)
{
	file = "arenahorn_02.wav";
	vol = 127;
};
...
instance SVM_16_AARGH(C_SFX_DEF)
{
	file = "BAB_Hurt01.wav";
	vol = 75;
};

instance SVM_16_AARGH_1(C_SFX_DEF)
{
	file = "BAB_Hurt02.wav";
	vol = 75;
};

instance SVM_16_AARGH_2(C_SFX_DEF)
{
	file = "BAB_Hurt01.wav";
	vol = 60;
};

instance SVM_16_AARGH_3(C_SFX_DEF)
{
	file = "BAB_Hurt02.wav";
	vol = 65;
};

instance SVM_16_AARGH_4(C_SFX_DEF)
{
	file = "BAB_Hurt01.wav";
	vol = 65;
};
...
instance SVM_16_DEAD(C_SFX_DEF)
{
	file = "BAB_Die01.wav";
	vol = 100;
};
...
instance SVM_16_BERZERK(C_SFX_DEF)
{
	file = "BAB_Hurt01.wav";
	vol = 75;
};
