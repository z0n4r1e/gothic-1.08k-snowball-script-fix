...
const string STAT_FONT_TITLE = "font_old_10_white_hi.tga";

const int MENU_SLIDER_DX = 2000;
const int MENU_SLIDER_DY = 400;
const int MENU_SLIDER_YPLUS = 180;
const int MENU_CHOICE_DX = 2000;
const int MENU_CHOICE_DY = 400;
const int MENU_CHOICE_YPLUS = 180;
const int MENU_TITLE_Y = 800;
const int MENU_START_Y = 1900;
const int MENU_BACK_Y = 6900;
const int MENU_DY = 700;
const int MENU_INFO_X = 300;
const int MENU_INFO_Y = 7780;

const string MENU_TEXT_NEEDS_APPLY = "";
const string MENU_TEXT_NEEDS_RESTART = "Некоторые Настройки станут активными только после Перезагрузки.";
