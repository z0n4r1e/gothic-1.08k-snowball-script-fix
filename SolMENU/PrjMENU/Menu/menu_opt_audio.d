...
instance MENUITEM_AUDIO_SFXVOL(C_MENU_ITEM_DEF)
{
	backpic = MENU_ITEM_BACK_PIC;
	text[0] = "Громк. речи";
	text[1] = "Уровень громкости эффектов и речи";
	posx = 500;
...
instance MENUITEM_AUDIO_MUSICVOL(C_MENU_ITEM_DEF)
{
	backpic = MENU_ITEM_BACK_PIC;
	text[0] = "Громк. музыки";
	text[1] = "Уровень громкости музыкального сопровождения.";
	posx = 500;
...
instance MENUITEM_AUDIO_MUSIC(C_MENU_ITEM_DEF)
{
	backpic = MENU_ITEM_BACK_PIC;
	text[0] = "Музыка";
	text[1] = "Включить или выключить музыку.";
	posx = 500;
...
instance MENUITEM_AUDIO_PROVIDER(C_MENU_ITEM_DEF)
{
	backpic = MENU_ITEM_BACK_PIC;
	text[0] = "Звук. драйвер";
	text[1] = "Перезапустите игру, чтобы использовать новые настройки.";
	posx = 500;
...
instance MENUITEM_AUDIO_REVERB(C_MENU_ITEM_DEF)
{
	backpic = MENU_ITEM_BACK_PIC;
	text[0] = "Искажение";
	text[1] = "Включает искажение звуков в пещерах (необходим перезапуск).";
	posx = 500;
